  ...
  <div class="min-h-screen">
    ...
    <section class="mx-auto max-w-7xl px-4 py-12">
      <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <!-- Menú del Día -->
        <NuxtLink to="/menu-diario" class="group">
          <BaseCard
        ...
        <!-- Reservas -->
        <NuxtLink to="/reservas" class="group">
          <BaseCard
        ...
        <!-- Eventos -->
        <NuxtLink to="/eventos" class="group">
          <BaseCard
        ...
        <!-- Contacto -->
        <NuxtLink to="/contacto" class="group">
          <BaseCard
